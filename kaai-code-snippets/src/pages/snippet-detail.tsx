  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-sm glass-card rounded-2xl p-5 space-y-4 border border-border/60 shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        ...
        <p className="text-xs text-muted-foreground/70 truncate">{snippetTitle}</p>
        ...
        <div className="space-y-2.5">
          ...
          {slugUrl && (
            <div className="space-y-1">
              <div className="flex items-center gap-1.5 text-[10px] text-blue-400/70">
                ...
                <span>Link Slug (Direkomendasikan)</span>
              </div>
              <div className="flex items-center gap-1.5 rounded-lg border border-blue-500/20 bg-blue-500/5 px-2.5 py-2">
                ...
                <button
                  ...
                  className={cn(
                    "shrink-0 h-6 px-2 rounded-md text-[10px] font-medium border transition-all",
                    copiedSlug
                      ? "border-green-500/30 bg-green-500/10 text-green-400"
                      : "border-blue-500/25 bg-blue-500/10 text-blue-400 hover:bg-blue-500/20",
                  )}
                >
                  {copiedSlug ? <><Check className="w-3 h-3 inline mr-0.5" />OK</> : <><Copy className="w-3 h-3 inline mr-0.5" />Salin</>}
                </button>
              </div>
            </div>
          )}
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground/60">
              ...
              <span>Link ID (Permanen)</span>
            </div>
            <div className="flex items-center gap-1.5 rounded-lg border border-border/40 bg-secondary/30 px-2.5 py-2">
              <span className="text-[11px] text-muted-foreground truncate flex-1 font-mono">
                {idUrl}
              </span>
              <button
                ...
                className={cn(
                  ...
                  copiedId
                    ? "border-green-500/30 bg-green-500/10 text-green-400"
                    : "border-border/50 bg-secondary/60 text-muted-foreground hover:text-foreground hover:bg-white/5",
                )}
              >
                {copiedId ? <><Check className="w-3 h-3 inline mr-0.5" />OK</> : <><Copy className="w-3 h-3 inline mr-0.5" />Salin</>}
              </button>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full h-9 rounded-xl bg-blue-600/20 border border-blue-500/30 text-blue-400 text-xs font-medium hover:bg-blue-600/30 transition-colors flex items-center justify-center gap-1.5"
        >
